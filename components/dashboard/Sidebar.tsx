...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'flex flex-col bg-surface border-r border-border h-screen transition-all duration-300 shrink-0',
        collapsed ? 'w-16' : 'w-56'
      )}
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 h-14 border-b border-border">
        ...
        <button
          ...
          className="text-text-muted hover:text-gold transition-colors p-1 ml-auto"
